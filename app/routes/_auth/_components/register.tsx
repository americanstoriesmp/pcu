...
const SignUpRoot = React.forwardRef<SignUpRootElement, SignUpRootProps>(
	(props, forwardedRef) => {
...
const SignUpControl = React.forwardRef<
	SignUpControlElement,
	SignUpControlProps
>((props, forwardedRef) => {
...
const SignUpMessage = React.forwardRef<
...
type FormValidityStateProps = React.ComponentPropsWithoutRef<
	typeof Form.ValidityState
>;
...
const SignUpEmailField = React.forwardRef<
	SignUpEmailFieldElement,
...
const SignUpEmailInput = React.forwardRef<
...
const SignUpPasswordField = React.forwardRef<
	SignUpPasswordFieldElement,
...
const SignUpPasswordInput = React.forwardRef<
...
type SignUpConfirmPasswordFieldElement = React.ElementRef<
	typeof ConfirmPasswordField
>;
type ConfirmPasswordFieldProps = React.ComponentPropsWithoutRef<
	typeof ConfirmPasswordField
>;
...
type SignUpConfirmPasswordInputElement = React.ElementRef<
	typeof ConfirmPasswordInput
>;
type ConfirmPasswordInputProps = React.ComponentPropsWithoutRef<
	typeof ConfirmPasswordInput
>;
...
type SignUpMatchingPasswordMessageElement = React.ElementRef<
	typeof MatchingPasswordMessage
>;
type MatchingPasswordMessageProps = React.ComponentPropsWithoutRef<
	typeof MatchingPasswordMessage
>;
interface SignUpMatchingPasswordMessageProps
	extends MatchingPasswordMessageProps {}
