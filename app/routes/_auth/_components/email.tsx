...
const EmailField = React.forwardRef<EmailFieldElement, EmailFieldProps>(
	(props, forwardedRef) => {
...
const EmailInput = React.forwardRef<EmailInputElement, EmailInputProps>(
	(props, forwardedRef) => {
		return (
			<Form.Control type="email" required {...props} ref={forwardedRef} />
		);
	}
);
